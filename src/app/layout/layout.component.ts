...
export class LayoutComponent implements OnInit {
  ...
  public menuTopList = [];
  public menuList = [];
  constructor(private router : Router,private sharedService : MainServiceServiceService,
  ...
  loadTopMenuList(){
    ...
    this.sharedService.getService("headerMenu",jsonData)
    .subscribe( (response) =>{
  ...
  loadMenuList(){
    ...
    this.menuList = [];
    this.sharedService.getService("getMenuListByRoleName", jsonStr)
    .subscribe( (response) =>{
